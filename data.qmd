...
df <- df %>%
  mutate(
    Total.All.Star.Selections = replace(Total.All.Star.Selections, is.na(Total.All.Star.Selections), 0),
    Total.All.NBA.Selections = replace(Total.All.NBA.Selections, is.na(Total.All.NBA.Selections), 0),
    Total.Championships = replace(Total.Championships, is.na(Total.Championships), 0)
  )
```
